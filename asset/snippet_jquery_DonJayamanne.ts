...
https://github.com/DonJayamanne/jquerysnippets/blob/master/snippets/javascript.json

Change $0 to ${// Code here}

*/

const snippet_jquery_DonJayamanne = {
	"func": {
		"prefix": "func",
		"body": [
			"function (${param}) {  }"
...
export default snippet_jquery_DonJayamanne;
