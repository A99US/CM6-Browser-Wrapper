...
https://github.com/capaj/vscode-standardjs-snippets/blob/master/snippets/javascript.json
...
const snippet_js_capaj = {
  ...
  "await Promise.all with destructuring": {
    "prefix": "apad",
    "body": "const [${99}] = await Promise.all(${1:value})"
  },
  ...
  "await sleep": {
    "prefix": "ast",
    "body": "await new Promise((r) => setTimeout(r, ${99}))"
  },
  "Node callback": {
    "prefix": "cb",
  ...
  "import module destructured": {
    "prefix": "imd",
    "body": "import { ${2:variable} } from '${1:module}'"
  },
  "typeof": {
    "prefix": "to",
  ...
  "JSON.stringify()": {
    "prefix": "js",
    "body": "JSON.stringify(${99:// Type here})"
  },
  "JSON.parse()": {
    "prefix": "jp",
    "body": "JSON.parse(${99:// Type here})"
  },
  "method": {
    "prefix": "m",
  ...
  "ternary assignment": {
    "prefix": "ta",
    "body": "const ${99} = ${1:cond} ? ${2:true} : ${3:false}"
  },
...
export default snippet_js_capaj
